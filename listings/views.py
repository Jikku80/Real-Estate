...
class SearchView(APIView):
    ...
    def post(self, request, format=None):
        ...
        if price == 'Rs.0+':
            price = 0
        elif price == 'Rs.1,00,000+':
            price = 100000
        elif price == 'Rs.5,00,000+':
            price = 500000
        elif price == 'Rs.10,00,000+':
            price = 1000000
            ...
            price = 20000000
        elif price == 'Rs.4,00,00,000+':
            price = 40000000
        elif price == 'Rs.10,00,00,000+':
            price = 100000000
        elif price == 'Any':
            price = -1
        ...
        queryset = queryset.filter(Q(
            description__icontains=keywords) | Q(title__icontains=keywords) | Q(city__icontains=keywords) | Q(province__icontains=keywords) | Q(address__icontains=keywords))
